...
const CASE_STUDIES = [
    {
        ...
        desc: 'Xây dựng nền tảng SaaS đa khách hàng (Multi-tenant) cho phép quản trị tập trung hàng chục chi nhánh và tổ chức. Bao gồm website động, CMS đa ngôn ngữ, hệ thống quyên góp minh bạch và dashboard phân tích dữ liệu.',
        impact: [
            { num: '8+', label: 'Tổ chức đang vận hành' },
    ...
    },
    {
        ...
        title: 'Trợ lý AI Tri thức Phật giáo (Dharma RAG)',
        desc: 'Hệ thống trí tuệ nhân tạo RAG (Retrieval-Augmented Generation) chuyên biệt. Trả lời câu hỏi với nguồn trích dẫn chính xác từ tài liệu chuyên môn, đảm bảo không bịa đặt (zero hallucination).',
        impact: [
            { num: '500+', label: 'Tài liệu kiến thức' },
    ...
    },
    {
        ...
        title: 'Số hóa Di sản Văn hóa Khmer',
        desc: 'Dự án số hóa toàn diện di sản văn hóa Khmer — bao gồm thư viện tài liệu truyền thống, bộ sưu tập hình ảnh, video đào tạo và tư liệu lịch sử. Bảo tồn cho thế hệ tương lai bằng công nghệ lưu trữ đám mây.',
        impact: [
            { num: '1,200+', label: 'Tài liệu đã số hóa' },
            { num: '50+', label: 'Video đào tạo HD' },
            { num: '∞', label: 'Thời gian bảo tồn' },
        ],
        tags: ['Supabase Storage', 'CDN', 'OCR', 'Metadata', 'SEO'],
        accent: '#F59E0B',
    ...
    },
    {
        ...
        desc: 'Hệ thống công khai toàn bộ giao dịch tài chính của tổ chức, cho phép cộng đồng giám sát và đánh giá tính minh bạch. Tích hợp dashboard thời gian thực, timeline cột mốc và báo cáo tác động.',
        impact: [
