    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-playfair font-bold text-slate-900 font-serif">Mạng lưới Đối tác</h1>
                ...
                <Link href={`/admin/t/${tenant_id}/organizations/new`}>
                    <Button className="gap-2 bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-600/20 rounded-xl">
            ...
            {organizations.length === 0 ? (
                <Card className="border-dashed border-2 bg-slate-50/50">
                    <CardContent className="py-20 text-center text-gray-400">
                        ...
                        <h3 className="text-lg font-bold text-gray-500">Chưa có đối tác nào</h3>
                        ...
                        <Card key={org.id} className="hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-0 shadow-md group overflow-hidden bg-white/80 backdrop-blur-md rounded-2xl ring-1 ring-slate-200">
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-start justify-between mb-4">
                                    <div className="w-14 h-14 bg-slate-50 rounded-2xl flex items-center justify-center border border-slate-100 shadow-inner group-hover:bg-blue-50 transition-colors">
                                        {org.logo_url ? (
                                ...
                                <div className="mb-6">
                                    <h3 className="font-bold text-xl text-slate-900 group-hover:text-blue-600 transition-colors line-clamp-1">{org.name}</h3>
                                ...
                                <div className="flex items-center gap-3 pt-4 border-t border-slate-50 mt-auto">
                                    <Link href={`/admin/t/${tenant_id}/organizations/${org.id}`} className="flex-1">
                                        <Button variant="secondary" className="w-full rounded-xl gap-2 text-slate-600 hover:text-blue-600 hover:bg-blue-50 transition-all font-bold">
