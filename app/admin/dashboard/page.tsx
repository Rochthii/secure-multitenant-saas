    ...
    return (
        <div className="space-y-8 pb-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="relative z-10 p-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div className="flex items-center gap-4 mb-4">
                            <div className="p-3 bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl shadow-lg shadow-amber-500/20 border border-amber-400/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xl bg-white dark:bg-slate-900/60 backdrop-blur-xl text-slate-900 dark:text-white relative overflow-hidden group rounded-[2rem] hover:shadow-[0_0_30px_-5px_rgba(16,185,129,0.3)] hover:border-emerald-500/50 transition-all duration-500">
                    ...
                    <CardContent className="p-7 relative z-10">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">Mức độ Tuân thủ Bảo mật</p>
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xl bg-white dark:bg-slate-900/60 backdrop-blur-xl text-slate-900 dark:text-white relative overflow-hidden group rounded-[2rem] hover:shadow-[0_0_30px_-5px_rgba(245,158,11,0.3)] hover:border-amber-500/50 transition-all duration-500">
                    <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-amber-500/10 rounded-full blur-3xl pointer-events-none transition-transform group-hover:scale-150 duration-700" />
                    <CardContent className="p-7 relative z-10">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">Lượt truy cập (24h)</p>
                                <h3 className="text-4xl font-black text-slate-900 dark:text-white">{securityStats.last24hLogs}</h3>
                                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-amber-500/10 border border-amber-500/20 text-xs text-amber-600 dark:text-amber-400 mt-3 font-bold shadow-inner">
                                    <Fingerprint className="w-3.5 h-3.5" /> Phiên hoạt động
                                </div>
                            </div>
                            <div className="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-slate-800/80 flex items-center justify-center border border-slate-200 dark:border-slate-700 shadow-sm group-hover:bg-amber-500/10 group-hover:scale-110 transition-all">
                                <Activity className="w-6 h-6 text-amber-500 dark:text-amber-400 group-hover:drop-shadow-[0_0_8px_rgba(245,158,11,0.8)]" />
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="border border-slate-200 dark:border-slate-800 shadow-xl bg-white dark:bg-slate-900/60 backdrop-blur-xl text-slate-900 dark:text-white relative overflow-hidden group rounded-[2rem] hover:shadow-[0_0_30px_-5px_rgba(244,63,94,0.3)] hover:border-rose-500/50 transition-all duration-500 flex flex-col justify-between">
                    ...
                    <CardContent className="p-7 relative z-10 flex-1">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">Cảnh báo Bất thường</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="lg:col-span-2 border border-slate-200 dark:border-slate-800/60 shadow-2xl overflow-hidden rounded-[2.5rem] bg-white dark:bg-slate-900/40 backdrop-blur-xl relative">
                    {/* Background glow */}
                    <div className="absolute top-0 right-0 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl pointer-events-none mix-blend-screen" />
                    ...
                    <CardHeader className="bg-slate-50/50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800 p-8 pb-6 relative z-10">
                        <CardTitle className="text-xl font-black text-slate-900 dark:text-white flex items-center gap-3">
                            <div className="p-2 bg-amber-500/20 text-amber-500 dark:text-amber-400 rounded-xl shadow-[0_0_15px_rgba(245,158,11,0.2)] border border-amber-500/30">
                                            ...
                                            <tr key={tenant.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors group">
                                                <td className="px-8 py-5">
                                                    <div className="flex items-center gap-4">
                                                        <div className="w-12 h-12 rounded-[1rem] flex items-center justify-center bg-amber-500/10 text-amber-600 dark:text-amber-400 font-black text-lg shadow-sm border border-amber-500/20 group-hover:bg-amber-50 group-hover:text-white transition-colors relative">
                                                        ...
                                                        <div>
                                                            <div className="flex items-center gap-2">
                                                                <p className="font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-300 transition-colors">{tenant.name}</p>
                                                ...
                                                <td className="px-8 py-5 text-right">
                                                    <Link 
                                                        ...
                                                        className="inline-flex items-center justify-center gap-2 text-xs text-amber-600 dark:text-amber-300 hover:text-white font-bold px-4 py-2.5 rounded-xl bg-amber-500/10 hover:bg-amber-600 transition-all border border-amber-500/20 hover:shadow-[0_0_20px_rgba(245,158,11,0.4)] hover:border-amber-500"
                                                    >
                        ...
                        <CardContent className="p-7 relative z-10">
                            <div className="space-y-4">
                                {stats.recentTenants.slice(0, 3).map((tenant: any) => (
                                    <div key={tenant.id} className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/30 border border-slate-100 dark:border-slate-800 hover:border-amber-500/50 hover:bg-amber-500/10 hover:shadow-[0_0_15px_rgba(245,158,11,0.15)] transition-all group">
                                        <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-700 dark:text-slate-300 font-black text-sm shadow-sm group-hover:border-amber-500 group-hover:text-amber-500 group-hover:shadow-[0_0_10px_rgba(245,158,11,0.3)] transition-colors">
                                            {tenant.name.charAt(0)}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-bold text-slate-800 dark:text-slate-200 truncate group-hover:text-amber-600 dark:group-hover:text-white transition-colors">{tenant.name}</p>
                                        ...
                                        <Link href={`/admin/tenants/${tenant.id}`} className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-amber-600 hover:text-white hover:border-amber-500 transition-colors text-slate-500 dark:text-slate-400 shadow-sm group-hover:shadow-[0_0_10px_rgba(245,158,11,0.3)]">
