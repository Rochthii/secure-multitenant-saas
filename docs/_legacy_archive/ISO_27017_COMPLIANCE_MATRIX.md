...
* **Giải pháp:** Sử dụng Postgres Trigger kết hợp hàm PL/pgSQL để chặn đứng mọi tác vụ cập nhật/xoá ở mức Database Engine cao nhất:
  ...
  $$ LANGUAGE plpgsql;
  ```
* **Kết quả:** Kiểm chứng thực tế qua script [verify_thesis_security.ts](file:///e:/Projects/Project_TN/PTIT_THESIS_SAAS/scripts/verify_thesis_security.ts) xác nhận hành vi xoá dấu vết bị chặn đứng 100%.
